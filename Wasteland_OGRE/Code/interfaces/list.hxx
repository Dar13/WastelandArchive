...
#ifndef E__OGRE_BUILD_BIN_DEBUG_RESOURCE_XML_SCHEMAS_LIST_HXX
#define E__OGRE_BUILD_BIN_DEBUG_RESOURCE_XML_SCHEMAS_LIST_HXX
...
::std::auto_ptr< ::list_t >
list (const ::xercesc::DOMDocument& d,
      ::xml_schema::flags f = 0,
      const ::xml_schema::properties& p = ::xml_schema::properties ());

::std::auto_ptr< ::list_t >
list (::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument >& d,
      ::xml_schema::flags f = 0,
      const ::xml_schema::properties& p = ::xml_schema::properties ());
...
#endif // E__OGRE_BUILD_BIN_DEBUG_RESOURCE_XML_SCHEMAS_LIST_HXX
