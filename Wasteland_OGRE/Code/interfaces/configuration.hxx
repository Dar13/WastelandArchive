...
class graphics_t: public ::xml_schema::type
{
  ...
  // fullscreen
  // 
  typedef ::xml_schema::string fullscreen_type;
  ...
  void
  fullscreen (::std::auto_ptr< fullscreen_type > p);

  // Constructors.
  //
  graphics_t (const resolution_type&,
              const fullscreen_type&);
...
class configuration_t: public ::xml_schema::type
{
  ...
  // Constructors.
  //
  configuration_t (const graphics_type&,
                   const action_type&,
                   const movement_type&,
                   const volume_type&);

  configuration_t (::std::auto_ptr< graphics_type >&,
