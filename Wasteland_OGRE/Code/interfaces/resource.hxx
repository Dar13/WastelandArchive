...
#ifndef E__OGRE_BUILD_BIN_DEBUG_RESOURCE_XML_SCHEMAS_RESOURCE_HXX
#define E__OGRE_BUILD_BIN_DEBUG_RESOURCE_XML_SCHEMAS_RESOURCE_HXX
...
class location_t: public ::xml_schema::type
{
  public:
  // Type
  // 
  ...
  // Recursive
  // 
  typedef ::xml_schema::boolean Recursive_type;
  typedef ::xsd::cxx::tree::traits< Recursive_type, char > Recursive_traits;

  const Recursive_type&
  Recursive () const;
  ...
  ::xsd::cxx::tree::one< Recursive_type > Recursive_;
};

class resource_t: public ::xml_schema::type
{
  public:
  // GroupName
  // 
  ...
  // Constructors.
  //
  resource_t (const GroupName_type&);
  ...
  protected:
  ::xsd::cxx::tree::one< GroupName_type > GroupName_;
...
#endif // E__OGRE_BUILD_BIN_DEBUG_RESOURCE_XML_SCHEMAS_RESOURCE_HXX
